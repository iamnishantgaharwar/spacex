  ...
  return (
    <>
        <div className='text-white flex justify-center'>
            <img src={nishant} className=' h-52 w-52 rounded-full' />
        </div>
        ...
        {/* <label className='text-white block font-customMont font-semibold text-lg flex justify-center mt-2'>Linkdin:&nbsp;<a href='https://www.linkedin.com/in/iamnishantgaharwar/'>@iamnishantgaharwar</a></label>
        <label className='text-white block font-customMont font-semibold text-lg flex justify-center mt-2'>GitHub:&nbsp;<a href='https://github.com/iamnishantgaharwar'>@iamnishantgaharwar</a></label>
        <label className='text-white block font-customMont font-semibold text-lg flex justify-center mt-2'>Twitter:&nbsp;<a href='https://twitter.com/iamnishant_G'>@iamnishant_G</a></label> */}
